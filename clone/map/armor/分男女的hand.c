...
void create()
{
	...
	pj = random( (int) (sizeof(armor_shuxing) / 2) ) +1;
	...
	if ( random(10) > 5)
	{
		...
		set("material", "steel");
		set("long", "这是一双做工非常精细的护手，传说乃出自神界矮人工匠之手。\n");
		set("icon", "10072");
	}
	else
	{
		id = get_item_id(name, "shoutao");
		set_name(name + "手套"NOR, ({ id, "shoutao", "hands" }) );
		set("female_only", 1);
		set("material", "leather");
		set("long", "这是一双做工非常精细的手套，传说乃出自神界中美丽的精灵们之手。\n");
		set("icon", "10075");
	}
