...
void create()
{
	...
	string weapon = "null";
	tsjndj = 1000 + random(2000);
	jcjndj = 3000 + random(3000);
	shuxing = 6000 + random(12000);
	seteuid(getuid());
	
	set_name(HIG"森林贼盗"NOR, ({"senlin zeidao", "qiang dao", "zeidao"}) );
    set("title", HIY "绿林蛮汉" NOR);
    set("gender", "男性" );
    set("icon", "30001" );
    set("age", random(30)+20);
    set("long", "横行迷雾森林边缘的强盗，占着对地形熟悉对来迷雾森林江湖客攻击抢掠\n");
