...
void create()
{
	...
	string weapon = "null";
	tsjndj = 3000 + random(5000);
	jcjndj = 10000 + random(20000);
	shuxing = 15000 + random(20000);
	seteuid(getuid());
    ...
    set("int", 30);
    set("dex", 30);
    set("max_qi", 70000000 + random (7000000));
    set("max_jing", 5000000 + random (5000000));
    set("neili", 30000000);
    set("max_neili", 100000000);
	set("no_suck",1);
	//set("is_boss", 1);
    set("jiali", 10000 + random(10000));
    set("env/wimpy", 10);
