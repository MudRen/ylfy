...
void create()
{
	...
	string weapon = "null";
	tsjndj = 1000 + random(500);
	jcjndj = 1000 + random(1000);
	shuxing = 1000 + random(2000);
	seteuid(getuid());
    ...
    set("int", 30);
    set("dex", 30);
    set("max_qi", 50000+random(100000));
	//set("qi", 50000+random(100000));
    set("max_jing", 25000+random(50000));
	//set("jing", 25000+random(50000));
    set("neili", 200000+random(500000));
	...
	set("xyzx_sys/level", 100+random(300));
