...
void create()
{
	...
	string weapon = "null";
	tsjndj = 2000 + random(2000);
	jcjndj = 3000 + random(3000);
	shuxing = 4000 + random(4000);
	seteuid(getuid());
	
	set_name(YEL"草莽山贼"NOR, ({"caomang shanzei", "shanzei", "shan zei"}) );
    set("title", HIW "落草山贼" NOR);
    set("gender", "男性" );
    set("icon", "30002" );
    set("age", random(30)+20);
    set("long", "活动在野外的小贼，专打劫、偷窃经由这里的人们做些无本生意。\n");
    ...
    set("int", 30);
    set("dex", 30);
    set("max_qi", 200000+random(200000));
	//set("qi", 50000+random(100000));
    set("max_jing", 100000+random(100000));
	//set("jing", 25000+random(50000));
    set("neili", 500000+random(1000000));
    set("max_neili", 100000+random(300000));
	//set("jingli", 100000+random(500000));
    set("max_jingli", 100000+random(500000));
	set("no_suck",1);
    set("jiali", 100+random(1000));
	//set("end_boss", 1);
    set("env/wimpy", 10);
    set_temp("apply/attack", 10+random(50));
    set_temp("apply/defense", 10+random(50));
    set("combat_exp", 21000000);
	set("xyzx_sys/level", 1000+random(1000));
	...
	break;
	case 54: { //少林-醉棍
	set_skill("zui-gun", tsjndj);
    set_skill("yijinjing", tsjndj); 
    set_skill("jingang-quan", tsjndj); 
    set_skill("shaolin-shenfa", tsjndj);
    ...
    map_skill("dodge", "shaolin-shenfa");
	weapon = "/clone/weapon/club";	
	}
	break;
	case 55: { //少林-无影剑
	set_skill("wuying-jian", tsjndj);
    set_skill("yijinjing", tsjndj); 
    set_skill("yizhi-chan", tsjndj); 
    set_skill("shaolin-shenfa", tsjndj);
    map_skill("force", "yijinjing");
	...
	break;
	case 56: { //少林-日月鞭
	set_skill("riyue-bian", tsjndj);
    set_skill("yijinjing", tsjndj); 
    set_skill("nianhua-zhi", tsjndj); 
    set_skill("shaolin-shenfa", tsjndj);
    map_skill("force", "yijinjing");
	...
	break;
	case 57:{ //金蛇剑法
	set_skill("jinshe-zhui", tsjndj);
    set_skill("taixuan-gong", tsjndj);
    set_skill("jinshe-zhang", tsjndj);
    set_skill("jinshe-jian", tsjndj); 
    set_skill("shaolin-shenfa", tsjndj);
    ...
    map_skill("dodge", "shaolin-shenfa");
	weapon = "/d/jinshe/obj/jinshe-jian";	
	weapon = "/d/jinshe/obj/jinshe-zhui";	
	}
	break;
	}
	set("weapon", weapon);
