...
void create()
{
       ...
       {
            set("long",
                "这是系统奖励的"+this_object()->query("name")+",使用(openbox vipbox)打开看看!\n");
            set("unit","个");
            set("icon","06005");
            set("win_box",1);
        }
...
"/clone/gift/unknowdan","/clone/gift/xiandan","/clone/gift/xianxing","/clone/gift/xisuidan","/clone/gift/jiuzhuan","/clone/gift/magate","/clone/gift/mcrystal","/clone/gift/mdiamond","/clone/gift/mjade",
    ...
    message_vision(HIM"$N轻轻打开了["+this_object()->query("name")+"]的盖子,宝箱华为一道血色光华！\n"NOR,me);
