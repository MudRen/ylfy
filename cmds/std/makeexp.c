...
#define SCORE_COST 1000
#define GOLD_COST  500
#define MORE_MONEY_COST  10
...
int main(object me, string arg)
{
	...
	if ( !arg || sscanf(arg,"%s %s",dir,stitle) != 2 )
        return notify_fail("指令格式：　makelian north 陪练室 \n");
...
void enter_desc(object me,object gold, string s_title,string dir,string text)
{
	string *direc= ({"north", "south", "east", "west", "northup", "southup", 
		"eastup", "westup", "northdown", 
