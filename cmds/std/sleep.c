...
//            where->set("no_fight", 1);
            ...
            else
	    {
            ...
            call_out("wakeup",random((int)(900/me->query("con"))) , me, where);
...
REMOVE_CMD->do_remove(obj, inv[i]);        	
        ...
        call_out("wakeup2",random((int)(900/me->query("con"))) + 10, me,obj, where);
        call_out("wakeup2",random((int)(900/me->query("con"))) + 10, obj, me,where);
