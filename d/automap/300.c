...
void create()
{
	...
	set("exits", ([
"south" : __DIR__"299",
"southeast" : __DIR__"301",
"northwest" : __DIR__"967",
"southwest" : __DIR__"500",
"northeast" : __DIR__"736",
]));
	set("objects", ([
"/clone/map/npc/char_boss" : 1,
"/clone/map/npc/guai_boss" : 1,
"/clone/map/npc/jinlong" : 1,
"/clone/map/npc/guai" : 1,
]));
	setup();
}
