...
int do_du(string arg)
{
	...
	if ( jylevel / 10 >= me->query_int()) 
		return notify_fail("由于你的悟性不够，无法进一步研习高一层的九阳神功。\n");
...
//	if (jylevel >= 220)
//                return notify_fail("你已经无法再从经书上领悟到什么，要有更高的修为必须自已练了。\n");
	if (jylevel >= 140 && me->query("neili") < me->query("max_neili") + jylevel)
