...
void create()
{
        ...
        set("jing",5450000);
        set("max_qi",5460000); 
        set("max_jing",2450000);
		set("max_jingli", 100000);
		set("max_jing", 1050000);
        set("neili", 14500000);
        set("max_neili", 1450000);
        set("jiali", 180000);
        set("shen",5000000);
        set("xyzx_sys/level", 3400); 
        ...
        set_skill("xuanhualiu-quanfa", 2100);
        set_skill("feitian-yujianliu", 2000);
        set_skill("wuxing-dun", 2000);
        set_skill("shayi-xinfa", 1200);
