...
void create()
{
	...
	carry_object("d/kaifeng/obj/shan-jian")->wield();
}
...
int xiao_li()
{
	...
	{
		if ((ob->query("xyzx_sys/level") < 100)&&(ob->query("xyzx_sys/level") > 50)) ob->set("title", "翰林院编修");
		else if (ob->query("xyzx_sys/level") < 500) ob->set("title","乔阴县师爷");
		else if (ob->query("xyzx_sys/level") < 1000) ob->set("title","乔阴县令");
		else if (ob->query("xyzx_sys/level") < 2000) ob->set("title","雪亭镇县令");
		else if (ob->query("xyzx_sys/level") < 3000) ob->set("title", "平杨县令");
		else if (ob->query("xyzx_sys/level") < 4000) ob->set("title", "大同县令");
		else if (ob->query("xyzx_sys/level") < 5000) ob->set("title", "凤祥县令");
		else if (ob->query("xyzx_sys/level") < 6000) ob->set("title", "晋阳县令");
		else if (ob->query("xyzx_sys/level") < 7000) ob->set("title", "桐城县令");
		else if (ob->query("xyzx_sys/level") < 8000) ob->set("title", "杭州令");
		else if (ob->query("xyzx_sys/level") < 9000) ob->set("title", "杭州知府");
		else if (ob->query("xyzx_sys/level") < 10000) ob->set("title", "开封知府");
		else if (ob->query("xyzx_sys/level") < 11000) ob->set("title", "广州知府");
		else if (ob->query("xyzx_sys/level") < 12000) ob->set("title", "南京知府");
		else if (ob->query("xyzx_sys/level") < 13000) ob->set("title", "九门提督");
		else if (ob->query("xyzx_sys/level") < 14000) ob->set("title", "云贵总督");
		else if (ob->query("xyzx_sys/level") < 15000) ob->set("title", "两广总督");
		else if (ob->query("xyzx_sys/level") < 16000) ob->set("title", "两江总督");
		else if (ob->query("xyzx_sys/level") < 17000) ob->set("title", "礼部尚书员外郎");
		else if (ob->query("xyzx_sys/level") < 18000) ob->set("title", "礼部尚书");
		else if (ob->query("xyzx_sys/level") < 19000) ob->set("title", "户部尚书");
		else if (ob->query("xyzx_sys/level") < 20000) ob->set("title", "钦赐龙图阁大学士");
		else if (ob->query("xyzx_sys/level") < 25000) ob->set("title", "左丞相");
		else if (ob->query("xyzx_sys/level") < 30000) ob->set("title", "右丞相");
		else if (ob->query("xyzx_sys/level") < 35000) ob->set("title", "钦赐一等千里伯");
		else if (ob->query("xyzx_sys/level") < 40000) ob->set("title", "钦赐二等万户侯");
		else if (ob->query("xyzx_sys/level") < 45000) ob->set("title", "钦赐一等定北侯");
		else if (ob->query("xyzx_sys/level") < 50000) ob->set("title", "钦赐二等护国公");
		else if (ob->query("xyzx_sys/level") < 60000) ob->set("title", "钦赐一等鹿鼎公");
		else if (ob->query("xyzx_sys/level") < 70000) ob->set("title", "钦赐特等平西王");
