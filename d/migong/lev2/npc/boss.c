...
void create()
{
    ...
    set_skill("force", 15500);
    set_skill("dodge", 15550);
    set_skill("blade", 15580);
    set_skill("unarmed",15580);
    set_skill("parry", 15500);
    set_skill("sword", 15500);
    set_skill("linji-zhuang",5500);
    set_skill("jinding-zhang",5500);
    set_skill("huifeng-jian",5500);
    set_skill("yanxing-dao", 5580);
    set_skill("tiangang-zhi", 5580);
    set_skill("zhutian-bu",5550);
    set_skill("yugalism", 5580);
    set_skill("dushi-jiren",5500);
    set_skill("literate", 5500);
