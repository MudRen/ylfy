...
void create()
{
    ...
    set_skill("force", 15800);
    set_skill("huntian-qigong", 5800);
    set_skill("unarmed", 15850);
    set_skill("xianglong-zhang", 5850);
    set_skill("dodge", 15900);
    set_skill("xiaoyaoyou", 5950);
    set_skill("parry", 15900);
    set_skill("club", 15850);
    set_skill("dagou-bang", 5850);
    set_skill("begging", 5500);
    set_skill("checking", 5420);          // 道听途说
