...
void create()
{
    ...
    set_skill("force", 16420);
    set_skill("unarmed", 15420);
    set_skill("dodge", 15520);
    set_skill("parry", 15420);
    set_skill("sword", 15450);
    set_skill("zhemei-shou", 5460);
    set_skill("liuyang-zhang", 5460);
    set_skill("tianyu-qijian", 5460);
    set_skill("yueying-wubu", 5460);
    set_skill("bahuang-gong", 5460);
