...
void create()
{
    ...
    set_skill("force", 820);             // 基本内功
    set_skill("huntian-qigong", 820);    // 混天气功
    set_skill("unarmed", 820);           // 基本拳脚
    set_skill("xianglong-zhang", 820);   // 降龙十八掌
    set_skill("dodge", 820);             // 基本躲闪
    set_skill("xiaoyaoyou", 820);        // 逍遥游
    set_skill("parry", 820);             // 基本招架
