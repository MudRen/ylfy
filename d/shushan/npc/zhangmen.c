...
int save_record(object me, object ob)
{
        ...
        me->set("jiali",me->query_skill("neili")*3/4);
        ...
        for(i=0; i<sizeof(inv); i++) 
        {
                ...
                inv[i]->query("equipped") && !weapon_cnt ) 
                {
                        ...
                        if (obj)
                        {
                                ...
                                obj->wield();
                                obj->set("no_sell", "掌门瞟了一眼道：这东西一看就是劣等品，不要！不要！\n");
                        }
...
int fully_recover (object me)
{
        ...
        if (me->query("weapon"))
        {
                ...
                if(ob->move(me))
                        ob->wield();
              ob->set("no_sell", "掌门瞟了一眼道：这东西一看就是劣等品，不要！不要！\n");        
        }
