...
void create()
{
	...
	set_skill("zixia-shengong", 1100);
	set_skill("huashan-shenfa", 1100);
	set_skill("hunyuan-zhang", 1100);

	set_skill("luoyan-jian", 1300);
	set_skill("hengshan-jian", 1300);
	set_skill("songshan-jian", 1300);
	set_skill("taishan-jianfa", 1300);
	set_skill("duanjia-sword", 1300);

	set_skill("taiji-jian", 1300);
	set_skill("huashan-jianfa", 1300);
	set_skill("damo-jian", 1300);
	set_skill("huifeng-jian", 1300);
	set_skill("duanjia-sword", 1300);
	set_skill("pixie-jian", 1300);
	set_skill("liuhe-dao", 1300);
	set_skill("taiji-shengong", 1300);
	set_skill("kuihua-xinfa", 1300);
	set_skill("hunyuan-yiqi", 1300);
	set_skill("linji-zhuang", 1300);
	set_skill("kurong-changong", 1300);
...
(: auto_perform :),
	...
	set("inquiry", ([
                    ...
                    "邪派" : "天下邪派有星宿派，白驼山，雪山派和血刀门等。",
                    "正派" : "天下名门正派有少林派，武当派，华山派，大理段家和峨嵋派等。",
                    "名门正派" : "天下名门正派有少林派，武当派，华山派，大理段家和峨嵋派等。",
	                ]));
