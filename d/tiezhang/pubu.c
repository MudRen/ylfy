...
int lingwu(string arg)
{
	...
	me->receive_damage("jing",bl/2);
	if (me->query_skill(arg,1) > 2000)
		me->improve_skill(arg,sl/50+1);
	else if (me->query_skill(arg,1) > 1800)
		me->improve_skill(arg,sl/40+1);
	else if (me->query_skill(arg,1) > 1500)
		me->improve_skill(arg,sl/30+1);
	else if (me->query_skill(arg,1) > 1300)
		me->improve_skill(arg,sl/20+1);
	else if (me->query_skill(arg,1) > 1200)
		me->improve_skill(arg,sl/10+1);
	else if (me->query_skill(arg,1) > 1200)
		me->improve_skill(arg,sl/8+1);
	else if (me->query_skill(arg,1) > 1100)
		me->improve_skill(arg,sl/6+1);
	else
