...
int do_sell(string arg)
{
    ...
    if ( (obj->query("no_sell") || obj->query("no_drop")) 
		&& !obj->query("bind_master_level") ) return notify_fail("这东西是无价之宝，不能卖断！\n");
...
return notify_fail("这么多?我可买不起!\n");  
   ...
   i=0;
	...
	if ( obj && obj->query("xyzx_save_item") && obj->query("owner_id") )
		destruct(obj);
    return 1;
}
