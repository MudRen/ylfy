...
mapping query_action(object me)
{
	...
	{
		if (random(me->query_skill("chousui-zhang")) > 280 && me->query("neili") > 1000 )
		{
			me->add("neili", -100);
			return ([
		...
		if (random(me->query_skill("chousui-zhang")) > 250 && me->query("neili") > 800 )
		{
			me->add("neili", -75);
			return ([
		...
		if (random(me->query_skill("chousui-zhang")) > 200 && me->query("neili") > 600 )
		{
			me->add("neili", -50);
			return ([
		...
		if (random(me->query_skill("chousui-zhang")) > 180 && me->query("neili") > 500 )
		{
			me->add("neili", -20);
			return ([
		...
		if (random(me->query_skill("chousui-zhang")) > 150 && me->query("neili") > 400 )
		{
			me->add("neili", -10);
			return ([
	...
	if (random(me->query_skill("unarmed",1)) > 220 && me->query_skill("force",1) > 200 && me->query("neili") > 220 )
	{
		me->add("neili", -50);
		return ([
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	flvl = me->query("jiali");
	if (lvl < 100 || ! damage_bonus || me->query_skill_mapped("force") != "huagong-dafa" || me->query("neili") < 300)
		return;
	if (random(5)==0)
	{
