...
mapping query_action(object me, object weapon)
{
	...
	{
		me->add("neili", -50);
		return (["action": HIG"$N眼中射出一道青芒，手中$w使出"RED""+(order[random(13)])+"「天下无狗」"NOR""HIG"，劈天盖地般攻向$n"NOR,
		            "damage": 500,
		            "dodge":50,
		            "parry":80,
		            "force": 600,
...
int ob_hit(object ob, object me, int damage)
{
	...
	a=me->query("xyzx_sys/level", 1);
	p=ob->query("xyzx_sys/level", 1);
