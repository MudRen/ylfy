...
int perform(object me, object target)
{
	...
	{
		damage = me->query_skill("sword") + me->query_skill("blade") + me->query_skill("force") * 3;
	...
	{
		count = ap / 20;
		msg += HIR "$n" HIR "见$P" HIR "来势迅猛之极，一时不知该如何作出抵挡，竟呆立当场。\n" NOR;
	}
	else
	{
		msg += HIY "$n" HIY "见$p" HIY "来势迅猛之极，甚难防备，连忙振作精神，小心抵挡。\n" NOR;
		count = 0;
	}
