...
int perform(object me, object target)
{
	...
	if (!weapon || weapon->query("skill_type") != "sword" || me->query_skill_mapped("sword") != "duanjia-sword")
		return notify_fail("手中无剑,你怎么使得出「风雷四击」！\n");

	if( (int)me->query("neili") < 500 )
		return notify_fail("你的真气不够！\n");

	if( (int)me->query_skill("duanjia-sword",1) < 500 || me->query_skill_mapped("sword") != "duanjia-sword")
