...
([      "action": "$N悠地欺近$n，双拳贴在$n的衣服上，发出了一招「虎砲」。 ",
	"dodge" : 50,
	"parry" : 70,
	"damage" : 300,
    "damage_type":  "瘀伤",
...
([      "action": "$N一招「破蛇」击向$n的肘内侧，紧接着踏前一步，肘部跟进击打$n的$l",
	"dodge" : 30,
	"parry" : 10,
	"damage" : 80,
    "damage_type":  "瘀伤",
...
([      "action": "$N一招「朔光」，右拳将$n的右拳架开，右肘突然击向$n的$l。 ",
	"dodge" : 10,
	"parry" : 50,
	"damage" : 120,
    "damage_type":  "瘀伤",
...
([      "action": "$N大吼一声「弧月」，身子突然向后一倒，单手支地，$n正在犹豫之间，$N的右腿已到，踢向$n的$l。 ",
	"dodge" : 20,
	"parry" : 100,
	"damage" : 80,
    "damage_type":  "瘀伤",
...
([      "action": "$N使出了一招「神威」，双手揪住$n的衣襟，单膝磕向$n的$l。 ",
	"dodge" : 80,
	"parry" : 10,
	"damage" : 270,
    "damage_type":  "瘀伤",
...
([      "action": "$N向后一翻使出一招「龙破」，突然冲向$n，紧接着一个倒翻，单手支地，双腿似剪刀般绞向$n的颈部。 ",
	"dodge":                20,
	"parry":                30,
	"damage":                470,
    "damage_type":  "瘀伤",
...
([      "action": "$N一个转身，单腿踢向$n的面门，$n正欲招架，$N突然变招「紫电」踢向$n的小腹。 ",
	"dodge" : 150,
	"parry" : 10,
	"damage" : 100,
    "damage_type":  "瘀伤",
...
{
	return combo=="xuanhualiu-quanfa";
}
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	int flvl;
	string msg;
	int level, jiali, level2;
	object weapon;
	lvl  = me->query_skill("shayi-xinfa", 1);
	flvl = me->query("jiali");

	if (me->query_skill_mapped("force") == "shayi-xinfa" && lvl > 300 && random(3)==0)
	{
