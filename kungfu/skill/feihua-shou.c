...
inherit SKILL;
mapping *action = ({
([      "action" : "$N一招「回头望月」拧腰回身，右手一扬，一朵金花应声而出，带着嗤嗤声响飞向$N。",
        "force" : 40,
        "dodge" : 5,
        "damage": 15,
        "lvl" : 0,
...
([      "action" : "$N手中扣上几朵金花，用「漫天飞雨」的手法散出，各个击向$n的全身各处要穴。",
        "force" : 50,
        "dodge" : 10,
        "damage": 20,
        "lvl" : 8,
...
([      "action" : "$N欺身向前，双掌拍向$n诱敌，一式「暗渡陈仓」，虚晃一招，接着口中：“呸！”的一声吐出一朵金花射向$n。",
        "force" : 60,
        "dodge" : 15,
        "damage": 20,
        "lvl" : 60,
...
([      "action" : "$N左手弹出一朵金花，袭向$n,待到劲道稍弱时，一招「日月辉映」,右手电射出另一朵金花正中前者，结果前面的金花力道大增，迅猛无伦地射向$n，令$n大吃一惊。",
        "force" : 100,
        "dodge" : 20,
        "damage": 30,
        "lvl" : 100,
