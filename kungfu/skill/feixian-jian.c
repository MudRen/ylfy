...
mapping *action = (
{
	...
	([
    "action":"$N脚下步步生莲，手中$w在身前一划,一片扇形白光向$n扑去。\n"
	    "$n识得这招「轻罗小扇」的威力，连忙躲避不迭",
	    "damage":       180,
    "damage_type":    "割伤",
	]),
	([
    "action":"$N纵身跃起，手中$w带起万道银光，向$n的面门点去。\n"
	    "这招「乱洒星罗」果然把$n逼得手忙脚乱",
	    "damage":       210,
    "damage_type":    "刺伤",
	]),
	...
	([
    "action":"$N身如被狂风所吹,裙裾飘飘，手中$w向$n轻点数下！\n"
	    "这招「姑射仙人」玄妙非常，大有仙气,$n简直惊呆了",
	    "damage":       240,
    "damage_type":    "刺伤",
	]),
	([
    "action":"$N长袖飘舞,身形急转,转眼间就成了一片白雾。一道剑光从白雾中击向$n!\n"
	    "这招「月下轻舞」先保己,后伤敌,已立于不败之地",
	    "damage":       270,
    "damage_type":    "刺伤",
	]),
	([
    "action":"$N身随剑走，迅速无伦地在$n周围布下一道剑网。\n"
