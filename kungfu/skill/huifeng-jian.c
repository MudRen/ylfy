...
{
([      "name":   "清风袭月",
"action" : "$N剑尖剑芒暴长，一招"+(order[random(13)])+"「清风袭月」"NOR"，手中$w自左下大开大阖，一剑向右上向$n的$l",
	"force" : 250,
	"dodge" : 20,
	"damage" : 300,
	"lvl" : 0,
...
([      "name":   "飘雪穿云",
"action" : "$N长剑圈转，一招"+(order[random(13)])+"「飘雪穿云」"NOR"，手中$w平展下刺，一剑轻轻划过$n的$l",
	"force" : 260,
	"dodge" : 20,
	"damage" : 280,
	"lvl" : 0,
...
([      "name":   "千峰竞秀",
"action" : "$N长剑轻灵跳动，剑随身长，右手$w使出一式"+(order[random(13)])+"「千峰竞秀」"NOR"刺向$n的$l",
	"force" : 280,
	"dodge" : 15,
	"damage" : 350,
	"lvl" : 0,
...
([      "name":   "乌龙搅柱",
"action" : "$N剑芒吞吐，幻若灵蛇，右手$w使出一式"+(order[random(13)])+"「乌龙搅柱」"NOR"，剑势曼妙，刺向$n的$l",
	"force" : 220,
	"dodge" : 25,
	"damage" : 300,
	"lvl" : 0,
...
([      "name":   "大雁啼沙",
"action" : "$N屈腕云剑，剑光如彩碟纷飞，幻出点点星光，右手$w使出一式"+(order[random(13)])+"「大雁啼沙」"NOR"跃跃洒洒飘向$n的$l",
	"force" : 340,
	"dodge" : 25,
	"damage" : 320,
	"lvl" : 0,
...
([      "name":   "进退龙游",
"action" : "$N挥剑分击，剑势自胸前跃出，右手$w一式"+(order[random(13)])+"「进退龙游」"NOR"，毫无留恋之势，刺向$n的$l",
	"force" : 360,
	"dodge" : 115,
	"lvl" : 0,
	"damage" : 400,
...
([      "name":   "天地鹤翔",
"action" : "$N退步，左手剑指划转，腰部一扭，右手$w一记"+(order[random(13)])+"「天地鹤翔」"NOR"自下而上刺向$n的$l",
	"force" : 400,
	"dodge" : 135,
	"damage" : 400,
	"lvl" : 0,
...
int ob_hit(object ob, object me, int damage)
{
	...
	if (random(8)==0 && level2>=300 && me->query_skill_mapped("force") == "linji-zhuang")
	{
		...
		msg = HIG"$N 五心向天，运行日月二庄，益气升阳，益阴潜阳，升降反正，天地二气交泰于身，并配合峨嵋九阳功。灭绝之间顿时大起!！\n"NOR;
		msg += "$N神色一变,恢复了些活力！\n",
