...
mapping query_action(object me, object weapon)
{
        ...
        f_force=me->query_skill("force");
         if ( random(me->query_skill("hunyuan-zhang",1))> 200 && me->query_skill("parry",1) > 200&& random(10) >5) {
        ...
        if (random(me->query_skill("hunyuan-zhang",1))> 150 && me->query_skill("parry",1) > 150 && random(10) >5 ) {
                return ([
        ...
        if (random(me->query_skill("hunyuan-zhang",1))> 100 && me->query_skill("parry",1) > 100 && random(10) >5 ) {
                return ([
