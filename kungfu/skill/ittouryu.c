...
mapping *action = (
{
([   "action" : "$N双手持刀，高举过顶，突然向$n攻出一招「南无三」，$w以破竹之势直奔$n的要害而去",
	"dodge" : 10,
	"parry" : 20,
	"damage" : 320,
"damage_type" : "割伤",
	 ]),
([   "action" : "$N一招「地狱」猛地挥动$w向$n当头击下，$n退了一步，但$w的刀气不依不饶地袭向$n",
	"dodge" : 17,
	"parry" : 14,
	"damage" : 320,
"damage_type" : "瘀伤",
	 ]),
([  "action" : "$N手中的$w刀光暴长，「岚」！不可一世地撞向$n",
	"dodge" : 12,
	"parry" : 11,
	"damage" :310,
"damage_type" : "砍伤",
	 ]),
([   "action" : "$N挥动$w，一招「叶切合」如蛆附骨，点点不离$n",
	"dodge" : 80,
	"parry" : 80,
	"damage" : 340,
"damage_type" : "刺伤",
	 ]),
([   "action" : "$N手中的$w在$n攻击的间隙中抢攻了进去，$N手中的$w有如梦一般罩了下去",
	"dodge" : 70,
	"parry" : 70,
	"damage" : 390,
"damage_type" : "刺伤",
	 ]),
([  "action" : "$N低头躲过$n的一击，接着想也不想，反手一招「浮舟」$w带着三分惆怅，斩向$n的胸口",
	"dodge" : 120,
	"parry" : 120,
	"damage" : 320,
"damage_type" : "割伤",
...
mapping query_action(object me, object weapon)
{
	...
	{
		return ([ "action": RED""+(order[random(13)])+"「  牙突一式! 」"NOR""+HIY"$N突然加速！刺出后水平横扫,追击躲闪的$n!"NOR,
	...
	{
		return ([ "action": HIR""+(order[random(13)])+"「  牙突二式! 」"NOR""+HIY"$N突然加速！刀举头上,刺出后向$n运动劈下! "NOR,
		            "force" : 650+random(200),
		            "attack" : 50,
		            "dodge" : 70,
		            "damage": 650+random(200),
	...
	{
		return ([ "action": HIM""+(order[random(13)])+"「  牙突三式! 」"NOR""+HIY"$N突然加速！由下刺上,对跃起的$n使出牙突,这是是对空的招式！"NOR,
		            "force" : 650+random(200),
		            "attack" : 90,
		            "dodge" : 50,
		            "damage": 650+random(200),
	...
	{
		return ([ "action": HIW""+(order[random(13)])+"「  牙突零式! 」"NOR""+HIY"$N在离$n极近距离猛的将刀刺出,威力巨大,这乃是一招必杀技 ！"NOR,
		            "force" : 650+random(200),
		            "attack" : 120,
		            "dodge" : 50,
		            "damage": 650+random(200),
