...
mapping *action = ({
([      "action" : "$N藏刀内收，一招「顺天」，刀锋自下而上划了个半弧，向$n的$l挥去",
        "force" : 160,
        "dodge" : -10,
        "parry" : 5,
        "damage": 15,
...
([      "action" : "$N右手反执刀柄，刀尖对准自己，一招「不拘一格」，猛一挫身，$w直向$n的颈中斩去",
        "force" : 220,
        "dodge" : 5,
        "parry" : 5,
        "damage": 30,
...
([      "action" : "$N刀尖平指，一招「庖丁解牛」，一片片切骨刀气如飓风般裹向$n的全身",
        "force" : 370,
        "dodge" : 5,
        "parry" : 25,
        "damage": 90,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
        ...
        if( random( me->query_skill("blade") ) > random( victim->query_skill("force")) && me->query_skill_mapped("force") == "yiqiguan-riyue" ) {        
        if (me->query("yiqiguan-riyue")==1) {
        victim->receive_wound("qi", damage_bonus );
        msg= WHT "$n一个不防，被刀气中夹杂的“从心所欲”内劲所伤，$N嘿嘿直笑。\n" NOR;
        }
        if (me->query("yiqiguan-riyue")==2) {
        victim->receive_wound("qi",damage_bonus * 1.5 );
