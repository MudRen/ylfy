...
int perform(object me)
{
        ...
        skill1 = me->query_skill("xueshan-jianfa",1);
        ...
        msg = HIY "$N纵身跃起,使出"+HIR"「金乌堕地」"NOR+""+HIY"，挥舞"NOR""+weapon->name()+""NOR+HIY"从半空中挥刀直劈下来，\n刀锋离地尚有数尺，地下已是尘沙飞扬，败草落叶被刀风激得团团而舞，\n将$n逃遁退避的空隙封的严严实实。\n"NOR;
        ...
        if( ap > dp )
        {
            ...
            qi_wound = (int)me->query_skill("jinwu-blade")+(int)me->query_skill("blade",1)+(int)me->query_str(1)*10;
