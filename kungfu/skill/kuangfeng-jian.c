...
([  "action" : "$N一招"+HIY"「风卷残云」"NOR+"，手臂一抡，剑锋一卷，自上而下斩向$n",
	"force" : 190,
	"dodge" : 25,
	"damage" : 25,
	"lvl" : 20,
...
([  "action" : "$N快速挥舞$w，使出一招"+RED"「风中残烛」"NOR+"，幻起一片剑花罩向$n的$l",
	"force" : 260,
	"dodge" : 15,
	"damage" : 65,
	"lvl" : 58,
...
([  "action" : "$N一招"+HIC"「风剑霜剑」"NOR+"，只见漫天剑光闪烁，重重剑影向$n的全身涌去",
	"force" : 290,
	"dodge" : 20,
	"damage" : 85,
	"lvl" : 71,
...
([  "action" : "$N挪步小退，一招"+HIC"「风花雪月」"NOR+"，手中$w轻描淡写地挥出一剑，随即又“唰唰”连劈出两剑，后发先至，洒向$n的$l",
	"force" : 400,
	"dodge" : 20,
	"damage" : 150,
	"lvl" : 120,
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor, string limb)
{
	...
	if (random(3)==0 && level>=300 && me->query_skill_mapped("force") == "zixia-shengong")
	{
		if (random(2)==0)
		{
			victim->start_busy(2);
