...
int perform(object me, object target)
{
	...
	if( (me->query_skill("kuangfeng-jian",1) < 150 ) || (me->query_skill("huashan-neigong",1) < 150 ) )
		return  notify_fail("你的功夫还不够娴熟，不会使用狂风快剑。\n");

	if( !weapon || weapon->query("skill_type") != "sword" || me->query_skill_mapped("sword") != "kuangfeng-jian" )
