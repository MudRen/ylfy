...
int perform(object me, object target)
{
      ...
      /*  if ((int)me->query_skill("kurong-changong",1) < 180)
        ...
        if (! target->query("neili"))
                tell_object(target, HIC "你只觉丹田内竟似空空如也，一时说不出的难受。\n" NOR);
