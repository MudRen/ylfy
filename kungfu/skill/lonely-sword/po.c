...
//        if(my_fam["generation"] != 13)
        ...
        if ( skill < 60)
           ...
           me->improve_skill("lonely-sword",10+random((int)me->query_int(1)- 4));
        else if (skill < 140)
           me->improve_skill("lonely-sword",10+random((int)me->query_int(1)-9)); //*2-9
        else if (skill < 200)
           me->improve_skill("lonely-sword",10+random((int)me->query_int(1)*2-9)); //*4-9
        else
           me->improve_skill("lonely-sword",10+random((int)me->query_int(1)*3-9)); //*4-9
