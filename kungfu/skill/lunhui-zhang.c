...
{
([  "name": "报应不爽",
    "action": "$N口宣佛号，面色庄严，一招"+BLINK""+HIR"「报应不爽」"NOR"手中$w长驱直入，迳刺$n$l",
    "dodge": -10,
    "parry": -5,
	"damage": 40,
    "damage_type":  "刺伤"
...
([  "name": "大限将至",
    "action": "$N手中$w一荡，使出"+BLINK""+HIB"「大限将至」"NOR"，但见一道杖影隐隐约约，若有若无地向$n压下",
	"dodge": 15,
    "parry": -15,
	"damage": 40,
    "damage_type":  "砸伤"
...
([  "name": "回头是岸",
    "action":"只见$N手中$w疾横，斗地点出！这招"+BLINK""+HIM"「回头是岸」"NOR"轻灵飘逸，\n$n眼见杖风袭来，竟不知如何是好",
	"dodge": 20,
    "parry": -20,
	"damage": 40,
    "damage_type":  "刺伤"
...
([  "name": "在劫难逃",
    "action": "$N大喝一声，手中$w向$n兜头击落，兵器未至，已将$n各处退路封死，好一招"+BLINK""+HIC"「在劫难逃」"NOR"",
    "dodge":  -5,
	"parry": 0,
	"damage": 50,
    "damage_type":  "砸伤"
...
([   "name": "天网恢恢",
    "action": "$N倒提$w，轻轻一纵，一招"+BLINK""+HIW"「天网恢恢」"NOR"从$n意想不到的地方刺出，$n顿时手足无措，狼狈万分",
    "dodge": -10,
    "parry": -5,
	"damage": 35,
    "damage_type":  "刺伤"
...
([  "name": "再堕轮回",
    "action": "$N脸上突现煞气，举起手中$w，猛向$n$l击落，这招"+BLINK""+RED"「再堕轮回」"NOR"出手又快又狠",
	"dodge": 20,
    "parry": -15,
	"damage": 55,
    "damage_type":  "砸伤"
...
{
	if( (int)me->query("kee") < 20 || (int)me->query("force") < 5 )
