...
int perform(object me, object target)
{
	...
	msg = HIY "$N" HIY "手中" + weapon->name() + HIY "一声龙吟，三十七势苗家剑连环施出，将$n" HIY "罩在剑光之中。\n" NOR;
	...
	{
		msg += HIR "$p" HIR "只见得剑光万道，顿时被$P凌厉的剑招攻得应接不暇，连连后退！\n" NOR;
		count = ap / 20;
	...
	{
		msg += HIC "$n" HIC "见$N" HIC "剑势汹涌，霍霍剑光逼人而来，不敢大意，小心应付。\n" NOR;
		count = 0;
	}
