...
int perform(object me, object target)
{
        ...
        if ((int)me->query_skill("mingyu-shengong", 1) < 300)
                return notify_fail("你冥雨神功修为不够，无法施展" GUA "。\n");            
        ...
        if (me->query_skill_mapped("sword") != "mingyu-shengong")
                return notify_fail("你没有将冥雨神功运用于剑法，无法使用" GUA "。\n");
        ...
        {
            damage = me->query_skill("sword") + me->query_skill("mingyu-gong");
            target->add("qi",-damage*4);
		    target->add("eff_qi",-damage*4);
