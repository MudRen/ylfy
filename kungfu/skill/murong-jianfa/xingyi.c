...
int perform(object me, object target)
{
	...
	if( weapon = target->query_temp("weapon") )
	{
		...
		{
			damage = me->query_skill("shenyuan-gong") + me->query_skill("murong-jianfa");
	...
	else
	{
		...
		{
			damage = (int)me->query_skill("shenyuan-gong");
			damage = (int)me->query_skill("shenyuan-gong") +damage;
