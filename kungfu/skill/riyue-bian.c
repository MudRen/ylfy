...
mapping query_action(object me)
{
	...
	if (me->query_temp("riyue"))
	{
		return ([
            ...
            "force" : (me->query("gender")=="男性"?action[j]["force"]:action[j]["force"]/2)+me->query_str(1),
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	damage= (int) me->query("neili")/10;
	if (damage > 100000) damage = 100000;
	if (random(10)==0 && level2>=300 && (me->query_skill_mapped("force") == "yijinjing" || me->query_skill_mapped("force") == "hunyuan-yiqi" ))
	{
