...
int perform(object me, object target)
{
	...
	if( (int)me->query_skill("yijinjing", 1) < 200 || me->query_skill("yijing-force", 1) < 200 || me->query_skill("hunyuan-yiqi", 1) < 200)
		return notify_fail("你的禅宗内功等级不够，不能使用「日月轮转」。\n");
	...
	{
		msg = BCYN "紧跟着$N又宣“我佛慈悲！”，使出「月」字诀，内力返照空明，功力精纯，不露棱角，手中长索舞动时瞧不见半点影子无声无息，似缓实急，却又无半点风声，如鬼似魅，说不尽的诡异莫名。\n"NOR;
		message_vision(msg,me,target);
		if (random(10)>4)
		{
