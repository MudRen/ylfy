...
int perform(object me)
{
	   ...
	   if (me->query_temp("weapon") || me->query_temp("secondary_weapon"))
        ...
        if (!objectp(weapon2 = target->query_temp("weapon")) || (string)weapon2->query("skill_type") != "sword")
         {
        if (!objectp(weapon2 = target->query_temp("weapon")) || (string)weapon2->query("skill_type") != "axe")
         {
        if (!objectp(weapon2 = target->query_temp("weapon")) || (string)weapon2->query("skill_type") != "blade")
         {
        if (!objectp(weapon2 = target->query_temp("weapon")) || (string)weapon2->query("skill_type") != "staff")         
        ...
        damage = 10 + me->query_skill("unarmed");
