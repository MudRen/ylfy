// xuanfeng-tui.c 旋风扫叶腿
// modified by Venus Oct.1997
inherit SKILL;

mapping *action = ({
([      "action" : "$N双手虚晃，左脚猛地飞起，一式「风起云涌」，脚尖晃动，踢向$n的屁股",
        "damage" : 100,
        "dodge" : 15,
        "damage_type" : "瘀伤",
        "lvl" : 10,
...
([      "action" : "$N左脚顿地，别转身来抽身欲走，只一刹那间一回身，右脚一式「空谷足音」，猛踹$n的$l",
        "damage" : 120,
        "dodge" : 10,
        "damage_type" : "瘀伤",
        "lvl" : 0,
...
([      "action" : "$N左手一挣，反手扭搭住$n的右手，右脚同时踹出，既猛且准，一式「碧渊腾蛟」，踢中的$n的胸口",
        "damage" : 140,
        "dodge" : 15,
        "damage_type" : "瘀伤",
        "lvl" : 10,
...
([      "action" : "$N突然跃起，双足连环圈转，一式「秋风落叶」，足带风尘，攻向$n的全身",
        "damage" : 160,
        "dodge" : 15,
        "damage_type" : "瘀伤",
        "lvl" : 10,
...
([      "action" : "$N突然侧身，却步后退，一个前空翻，右脚自上而下一式「流星坠地」，照$n的面门直劈下来",
        "damage" : 200,
        "dodge" : 35,
        "damage_type" : "瘀伤",
        "lvl" : 30,
...
([      "action" : "$N使一式「朔风吹雪」，全身突然飞速旋转，双足忽前忽后，迅猛无极踹向$n的胸口",
        "damage" : 220,
        "dodge" : 30,
        "damage_type" : "瘀伤",
        "lvl" : 40,
...
([      "action" : "$N抽身跃起，开声吐气，大喝一声：嗨！一式「雷动九天」，双脚如旋风般踢向$n的$l",
        "damage" : 250,
        "dodge" : 35,
        "damage_type" : "瘀伤",
        "lvl" : 30,
