...
mapping *action = ({
  ([
    "action": "$N把"HIY"$w"NOR"平举起，脚一点地，全身螺旋般的旋起，朝着$n飞了过去!",
    "damage": 100,
    "dodge": -20,
    "parry": -10,
    "damage_type": "刺伤",
  ...
  ([
    "action": "$N一跃而起，在空中高举"HIY"$w"NOR"，大喝一声，对准$n的$l砸去！",
    "damage": 150,
    "dodge": -20,
    "parry": -20,
    "damage_type":   "劈伤",
  ...
  ([
    "action": "$N把"HIY"$w"NOR"拉得满满的，突然一放，只觉得一股劲气朝着$n呼啸而去!",
    "damage": 200,
    "dodge": -10,
    "parry": -10,
    "damage_type":   "刺伤",
  ...
  ([
    "action": "$N挥起手中的"HIY"$w"NOR"朝着$n的腹部击去，\n却突然把"HIY"$w"NOR"一横，想把$n的手套在弓上!",
    "damage": 250,
    "dodge": -20,
    "parry": 10,
    "damage_type":   "刺伤",
  ...
  ([
    "action": "只见$N按着八卦图形疾走，旋起一团尘土来扰乱$n的视线，\n然后握紧"HIY"$w"NOR"对准$n的$l砸去!",
    "damage": 300,
    "dodge": 10,
    "parry": -10,
    "damage_type": "砸伤",
