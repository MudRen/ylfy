...
mapping *action = ({
        ...
        ([      "action": "$N手中$w起起伏伏，忽上忽下，正是一招"+(order[random(13)])+"「怒发冲冠」"NOR"，枪锋泛起一片寒光，攻向$n的$l!",
                "damage": 70,
                "dodge": 40,
                "parry": 40,
                "force": 300,
        ...
        ([      "action": "$N身形一缓，聚气凝神，使出一招"+(order[random(13)])+"「潇潇雨歇」"NOR"，身形紧绷如弓，以$w为箭，趁$n一个破绽，如电射向$n。",
                "damage": 360,
                "dodge": 70,
                "parry": 30,
                "force": 350,
        ...
        ([      "action": "$N卖个破绽，却于$n疏乎之际，使出一招"+(order[random(13)])+"「抬望眼，仰天长啸」"NOR"，倒过枪柄忽如其来的敲向$n$l！",
                "damage": 360,
                "dodge": 30,
                "parry": 60,
                "force": 375,                
        ...
        ([      "action": "$N真力灌注$w，简简单单的横划出去，一招平凡的"+(order[random(13)])+"「壮怀激烈」"NOR"，在$N手中竟有如斯威力！",
                "damage": 380,
                "dodge": 60,
                "parry": 40,
                "force": 375,           
        ...
        ([      "action": "$N手中$w一晃，转身就走，突然一记"+(order[random(13)])+"「莫等闲，白了少年头，空悲切。」"NOR"由腋下刺出，$n发现时，枪尖已灵蛇般刺到$n眼前。",
                "damage": 360,
                "dodge": 30,
                "parry": 60,
                "force": 350,
        ...
        ([      "action": "$N手中$w高举，凝神静气，一式"+(order[random(13)])+"「靖康耻，尤未雪」"NOR"自上直击而下，$n犹如身处炼狱洪炉，不知所措。",
                "damage": 360,
                "dodge": 30,
                "parry": 60,
                "force": 350,
                ...
                "damage_type":  "挫伤"
                       ...
                       ([      "action": "$N口中吟道: "+(order[random(13)])+"「待从头收拾旧山河，朝天阙。」"NOR"，手中$w倒转，枪杆\n由下至上，直向$n的$l打去",
                                "dodge": 32,
                                "parry": 20,
                                "force" : 340,
                                 "damage": 360,
                        ...
                        ([      "action": "$N长叹道："+(order[random(13)])+"「靖康耻，犹未雪，臣子恨，何时灭！」"NOR"，手中$w晃出无数\n枪影，忽然一枪向$n的$l刺去",
                                "dodge": 30,
                                "parry": 40,
                                "force": 315,
                                "damage": 360,
                        ...
                        ([      "action": "$N面带忧色，吟道："+(order[random(13)])+"「三十功名尘与土。」"NOR"枪身突转，向$n的下盘扫去",
                                "dodge": 30,
                                "parry": 30,
                                "force": 350,
                                "damage": 360,
                        ...
                        ([      "action": "$N一声清啸，"+(order[random(13)])+"「驾长车，踏破贺兰山缺。」"NOR"，大踏步向前走来，手中$w\n平平递出，直取$n的$l",
                                "force": 330,
                                "dodge": 20,
                                "parry": 30,
                                 "damage": 360,
                        ...
                        ([      "action": "$N低头吟哦："+(order[random(13)])+"「八千里路云和月」"NOR"，手中$w凌空虚点，蓦地进步跟身，\n向$n扫出一排枪影",
                                "dodge": 30,
                                "parry": 30,
                                "force": 330,
                                "damage": 360,
                        ...
                        ([      "action": "$N慷慨激昂的诵道："+(order[random(13)])+"「壮志饥餐胡虏肉」"NOR"，手中长枪忽左忽右，游移不定，募然反\n身向$n的$l挑去",
                                "dodge": 56,
                                "parry": 13,
                                "force": 310,
                                "damage": 360,
