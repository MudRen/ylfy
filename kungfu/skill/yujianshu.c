...
mapping *action = ({
		([	"name":			"御剑生风",
		"action": "$N双脚一顿，笔直跃起，手中$w不停地颤抖着，\n"
                   "笼罩住$n全身。这势"HIC"「御剑生风」"NOR"果然是无孔不入",
		"dodge": -5,
		"parry": -10,
		"damage": 25,
		"damage_type":	"刺伤",
        "parry_msg":"$n稍退半步,手中的$W快速挥动,挡开了$N的攻势。\n",
        "parry_power": 15,
	]),
	([	"name":			"御剑如虹",
		"action": "$N手中$w带起点点寒光，指向$n前胸穴道。$n正专心致志地对付着剑招，\n"
                  "不料$N左手运力拍向$n的$l。这势"HIR"「御剑如虹」"NOR"亦真亦幻，实是难防",
		"dodge": -5,
		"parry": 15,
		"damage": 25,
		"damage_type":          "震伤",
        "parry_msg":"$n招法突变,手中的$W直刺$N,逼的$N只好收回招式。\n",
        "parry_power": 20,
	]),
	([	"name":			"御剑成龙",
		"action": "$N在$n四周游走，一招"HIY"[御剑成龙]"NOR",手中$w去势飘忽不定，只看得$n眼花缭乱。\n"
                  "趁此良机，$N于朦朦胧胧中一抖$w，向$n的$l疾挑",
		"dodge": -15,
		"parry": 10,
		"damage": 25,
		"damage_type":		"刺伤",
         "parry_msg":"$n不紧不慢,手中$W身前空处连刺数剑。挡开了$N的攻势。\n",
         "parry_power": 10,
	]),
	([	"name":			"御剑行空",
		"action": "$N仗起手中$w，带出点点寒光，罩住$n的胸腹，只等$n的破绽。\n"
	...
	([	"name": "御剑飞腾",
		"action": "$N手中$w向$n的右手疾刺，但正当$n要招架时，\n"
