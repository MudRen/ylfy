...
int perform(object me, object target)
{
	...
	if (random(me->query_skill("force",1)) > target->query_skill("force",1) / 5)
	{
		me->add("neili", -1000);
...
int perform2(object me, object target)
{
	...
	{
		write(HIW "你运转内力，仰天一声清啸，剑在空中盘旋了一圈，又飞回了你的手中。\n" NOR);
