...
//  give bonus to NPC kill
	...
	if( (int)me->query("xyzx_sys/level")> (int)target->query("xyzx_sys/level")/3)
	{
		...
		target->receive_wound("qi",damage+100);
	}
