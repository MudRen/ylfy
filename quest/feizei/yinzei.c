...
void create()
{
	...
	string weapon = "null";
	tsjndj = 1000 + random(10000);
	jcjndj = 5000 + random(20000);
	shuxing = 5000+random(15000);
	seteuid(getuid());	
	set_name("阿西吧",({ "yin zei"}) );
	set("title",HIY"脑袋秀逗的淫贼"NOR);
    set("gender", "男性" );
    set("age", random(30)+20);
    set("long", "这是无恶不做的淫贼，夜晚出现专门奸淫各种帅哥美女。\n");
    ...
    set("max_qi", 2000000+random(5000000));
	set("qi", 2000000+random(5000000));
    set("max_jing", 500000+random(5000000));
	set("jing", 500000+random(5000000));
    set("neili", 10000000+random(50000000));
    set("max_neili", 5000000+random(30000000));
	set("jingli", 1000000+random(50000000));
    set("max_jingli", 1000000+random(50000000));
	set("no_suck",1);
    set("jiali", 500+random(10000));
	//set("end_boss", 1);
    set("env/wimpy", 50);
    set_temp("apply/attack", 50+random(500));
    set_temp("apply/defense", 50+random(500));
    set("combat_exp", 2100000000);
	set("xyzx_sys/level", 2000+random(5000));
...
void die()
{
	...
	if ( objectp(me) && objectp(ob) && random(100000) < 1 )
	{
	...
	if ( objectp(me) && objectp(ob) && random(10000) < 1 )
	{
		baoshi = new(random_item[random(sizeof(random_item))]);
		name = baoshi->name(1);
	...
	if ( objectp(me) && objectp(ob) && random(100) < 30 )
	{
		baoshi = new(random_item[random(sizeof(random_item))]);
		name = baoshi->name(1);
